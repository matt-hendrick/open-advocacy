...
export const mockProjects: Project[] = [
  {
    ...
    description:
      'Advocating for the renovation of Lincoln Park with improved playground equipment and better accessibility features.',
  ...
  },
  {
    ...
    description:
      'Supporting increased funding for public libraries to expand digital services and educational programs.',
    status: ProjectStatus.ACTIVE,
    active: true,
    created_by: 'admin',
  ...
  },
  {
    ...
    description:
      'Advocating for speed bumps and improved signage to reduce speeding in residential neighborhoods.',
